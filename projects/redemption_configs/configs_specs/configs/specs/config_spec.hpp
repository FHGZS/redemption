...
void config_spec_definition(Writer && W)
{
    ...
    W.section("client", [&]
    {
        ...
        W.member(ini_and_gui, no_sesman, L, type_<bool>{}, "enable_osd_4_eyes", desc{"Enables display of message informing user that his/her session is being audited."}, set(true));
    ...
    W.section(W.names("mod_rdp", connpolicy::name{"rdp"}), [&]
    {
        ...
        W.member(advanced_in_gui, no_sesman, L, type_<bool>(), "session_probe_clipboard_based_launcher_reset_keyboard_status", set(true));
